...
The following are the currently (as of October 6, 2020) available features in it for the ISIM Application Server. Authorization (login) is clearly also available.

|    Entities\Operations    | Search | DN Lookup | Create | Delete | Suspend | Restore |   Modify   |
|:-------------------------:|:------:|:---------:|:------:|:------:|:-------:|:-------:|:----------:|
|           People          |    ✓   |           |    ✓   |    ✓   |    ✓    |    ✓    |      ✓     |
|       Dynamic Roles       |    ✓   |     ✓     |    ✓   |    ✓   |    ✓    |    ✓    |      ✓     |
|        Static Roles       |    ✓   |     ✓     |    ✓   |    ✓   |    ✓    |    ✓    |      ✓     |
...
request=person.request_access(s,access,"justification")
request_id=json.loads(request.content)["_links"]["result"]["href"].split("/")[-1] #this will be easier in the future
...
- Improve ISIM response handling
    - Just so you can get request IDs easily
- Request search and lookup
    - To automate testing even further
- Service operations
